...
function Footer() {
  const navLinks = [
    ...
    {
      path: "/contactus",
      display: "Contact Us",  // Added new link
    },
  ];
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="cols-span-1 md:col-span-4 text-left">
            ...
            <p className="text-md lg:text-lg text-black/70 font-medium">
              MediHub is your one-stop solution for managing healthcare services
              such as booking appointments, accessing medical records, and
